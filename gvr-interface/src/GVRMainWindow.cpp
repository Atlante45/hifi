...
void GVRMainWindow::showAddressBar() {
    ...
    connect(addressDialog, &QInputDialog::textValueSelected, DependencyManager::get<AddressManager>().data(),
...
void GVRMainWindow::showLoginFailure() {
    QMessageBox::warning(this, "Login Failed", "Could not log in with that username and password. Please try again!");
}

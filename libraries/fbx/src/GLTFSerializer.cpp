...
bool GLTFSerializer::getStringVal(const QJsonObject& object, const QString& fieldname, QString& value,
...
bool GLTFSerializer::getBoolVal(const QJsonObject& object, const QString& fieldname, bool& value,
                                QMap<QString, bool>& defined) {
...
bool GLTFSerializer::getDoubleVal(const QJsonObject& object, const QString& fieldname, double& value,
                                  QMap<QString, bool>& defined) {
...
bool GLTFSerializer::getObjectVal(const QJsonObject& object, const QString& fieldname, QJsonObject& value,
                                  QMap<QString, bool>& defined) {
...
bool GLTFSerializer::getIntArrayVal(const QJsonObject& object, const QString& fieldname, QVector<int>& values,
                                    QMap<QString, bool>& defined) {
...
bool GLTFSerializer::getDoubleArrayVal(const QJsonObject& object, const QString& fieldname, QVector<double>& values,
                                       QMap<QString, bool>& defined) {
    bool _defined = (object.contains(fieldname) && object[fieldname].isArray());
    if (_defined) {
        QJsonArray arr = object[fieldname].toArray();
...
bool GLTFSerializer::getObjectArrayVal(const QJsonObject& object, const QString& fieldname, QJsonArray& objects,
                                       QMap<QString, bool>& defined) {
    bool _defined = (object.contains(fieldname) && object[fieldname].isArray());
    if (_defined) {
...
bool GLTFSerializer::getIndexFromObject(const QJsonObject& object, const QString& field, int& outidx,
                                        QMap<QString, bool>& defined) {
            ...
            foreach (auto& primitive, _file.meshes[node.mesh].primitives) {
                ...
                foreach (auto& key, keys) {
                    ...
                    if (key == "POSITION") {
                        ...
                        success = addArrayOfType(buffer.blob, bufferview.byteOffset + accBoffset, accessor.count, colors,
                                                 accessor.type, accessor.componentType);
                        if (!success) {
                        ...
                        success = addArrayOfType(buffer.blob, bufferview.byteOffset + accBoffset, accessor.count, tangents,
                                                 accessor.type, accessor.componentType);
                        if (!success) {
...
bool GLTFSerializer::readArray(const QByteArray& bin, int byteOffset, int count, QVector<L>& outarray, int accessorType) {
...
template<typename T>
bool GLTFSerializer::addArrayOfType(const QByteArray& bin, int byteOffset, int count, QVector<T>& outarray, int accessorType,
                                    int componentType) {

...
DebugEnums<Dimension> DIMENSIONS {
    { Dimension::SCALAR, "scalar" }, { Dimension::VEC2, "vec2" },       { Dimension::VEC3, "vec3" },
    { Dimension::VEC4, "vec4" },     { Dimension::MAT2, "mat2" },       { Dimension::MAT3, "mat3" },
    { Dimension::MAT4, "mat4" },     { Dimension::TILE4x4, "tile4x4" }, { Dimension::NUM_DIMENSIONS, "num_dimensions" },
};

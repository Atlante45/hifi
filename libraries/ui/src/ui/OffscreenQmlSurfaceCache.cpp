...
QSharedPointer<OffscreenQmlSurface> OffscreenQmlSurfaceCache::buildSurface(const QString& rootSource) {
    ...
    QObject::connect(surface.data(), &hifi::qml::OffscreenSurface::rootContextCreated,
                     [this, rootSource](QQmlContext* surfaceContext) {
...
void OffscreenQmlSurfaceCache::setOnRootContextCreated(

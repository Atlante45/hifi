...
protected:
    PacketList(PacketType packetType, QByteArray extendedHeader = QByteArray(), bool isReliable = false,
...
template<typename T>
std::unique_ptr<T> PacketList::takeFront() {

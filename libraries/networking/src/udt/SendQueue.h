...
public:
    enum class State { NotStarted, Running, Stopped };
...
signals:
    ...
    void packetRetransmitted(int wireSize, int payloadSize, SequenceNumber seqNum,
...
private:
    SendQueue(Socket* socket, HifiSockAddr dest, SequenceNumber currentSequenceNumber, MessageNumber currentMessageNumber,

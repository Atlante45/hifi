...
static const int32_t log2Table[1 << LOG2_TABBITS][3] = {
    { -0x56dfe26d, 0x5c46daff, 0x00000000 }, { -0x4d397571, 0x5bae58e7, 0x00025a75 }, { -0x4518f84b, 0x5aabcac4, 0x000a62db },
    { -0x3e3075ec, 0x596168c0, 0x0019d0e6 }, { -0x384486e9, 0x57e769c7, 0x00316109 }, { -0x332742ba, 0x564f1461, 0x00513776 },
    { -0x2eb4bad4, 0x54a4cdfe, 0x00791de2 }, { -0x2ad07c6c, 0x52f18320, 0x00a8aa46 }, { -0x2763c4d6, 0x513ba123, 0x00df574c },
    { -0x245c319b, 0x4f87c5c4, 0x011c9399 }, { -0x21aac79f, 0x4dd93bef, 0x015fcb52 }, { -0x1f433872, 0x4c325584, 0x01a86ddc },
    { -0x1d1b54b4, 0x4a94ac6e, 0x01f5f13e }, { -0x1b2a9f81, 0x4901524f, 0x0247d3f2 }, { -0x1969fa57, 0x4778f3a7, 0x029d9dbf },
...
static const int32_t exp2Table[1 << EXP2_TABBITS][3] = {
    { 0x3ed838c8, 0x58b574b7, 0x40000000 }, { 0x41a0821c, 0x5888db8f, 0x4000b2b7 }, { 0x4488548d, 0x582bcbc6, 0x40039be1 },
    { 0x4791158a, 0x579a1128, 0x400a71ae }, { 0x4abc3a53, 0x56cf3089, 0x4017212e }, { 0x4e0b48af, 0x55c66396, 0x402bd31b },
    { 0x517fd7a7, 0x547a946d, 0x404af0ec }, { 0x551b9049, 0x52e658f9, 0x40772a57 }, { 0x58e02e75, 0x5103ee08, 0x40b37b31 },
    { 0x5ccf81b1, 0x4ecd321f, 0x410331b5 }, { 0x60eb6e09, 0x4c3ba007, 0x4169f548 }, { 0x6535ecf9, 0x49484909, 0x41ebcdaf },
    { 0x69b10e5b, 0x45ebcede, 0x428d2acd }, { 0x6e5ef96c, 0x421e5d48, 0x4352ece7 }, { 0x7341edcb, 0x3dd7a354, 0x44426d7b },
...
class MinFilter;
template<>
class MinFilter<16> : public MinFilterT<16, 7, 10> {};
template<>
class MinFilter<32> : public MinFilterT<32, 14, 19> {};
template<>
class MinFilter<64> : public MinFilterT<64, 27, 38> {};
template<>
class MinFilter<128> : public MinFilterT<128, 53, 76> {};
template<>
class MinFilter<256> : public MinFilterT<256, 106, 151> {};

template<int N>
class MaxFilter;
template<>
class MaxFilter<16> : public MaxFilterT<16, 7, 10> {};
template<>
class MaxFilter<32> : public MaxFilterT<32, 14, 19> {};
template<>
class MaxFilter<64> : public MaxFilterT<64, 27, 38> {};
template<>
class MaxFilter<128> : public MaxFilterT<128, 53, 76> {};
template<>
class MaxFilter<256> : public MaxFilterT<256, 106, 151> {};

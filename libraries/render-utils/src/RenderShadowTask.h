...
public:
    RenderShadowTaskConfig() :
        render::Task::Config::Persistent(QStringList() << "Render"
                                                       << "Engine"
                                                       << "Shadows",
                                         true) {}
...
public:
    using Inputs = render::VaryingSet5<render::ShapeBounds, render::ItemFilter, ViewFrustumPointer, LightStage::FramePointer,

...
public:
    using Inputs = render::VaryingSet6<render::ItemBounds, HazeStage::FramePointer, LightStage::FramePointer,
                                       LightingModelPointer, LightClustersPointer, glm::vec2>;
...
private:
    static const render::Varying addSelectItemJobs(JobModel& task, const char* selectionName, const render::Varying& metas,
                                                   const render::Varying& opaques, const render::Varying& transparents);
};

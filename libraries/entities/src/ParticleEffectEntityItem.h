...
struct Range {
    ...
    Range(const T& defaultStart, const T& defaultFinish) : start(defaultStart), finish(defaultFinish) {}
...
struct Gradient {
    ...
    Gradient(const T& defaultTarget, const T& defaultSpread) : target(defaultTarget), spread(defaultSpread) {}
...
struct RangeGradient {
    ...
    RangeGradient(const T& defaultValue, const T& defaultStart, const T& defaultFinish, const T& defaultSpread) :
        range(defaultStart, defaultFinish),
        gradient(defaultValue, defaultSpread) {}
...
public:
    ALLOW_INSTANTIATION // This class can be instantiated
        ...
        static EntityItemPointer
        factory(const EntityItemID& entityID, const EntityItemProperties& properties);

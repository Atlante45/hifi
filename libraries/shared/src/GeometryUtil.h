...
bool findRayTriangleIntersection(const glm::vec3& origin, const glm::vec3& direction, const glm::vec3& v0, const glm::vec3& v1,
                                 const glm::vec3& v2, float& distance, bool allowBackface = false);
...
inline bool findRayTriangleIntersection(const glm::vec3& origin, const glm::vec3& direction, const Triangle& triangle,
                                        float& distance, bool allowBackface = false) {
    return findRayTriangleIntersection(origin, direction, triangle.v0, triangle.v1, triangle.v2, distance, allowBackface);
}

inline bool findParabolaTriangleIntersection(const glm::vec3& origin, const glm::vec3& velocity, const glm::vec3& acceleration,
                                             const Triangle& triangle, float& parabolicDistance, bool allowBackface = false) {
    return findParabolaTriangleIntersection(origin, velocity, acceleration, triangle.v0, triangle.v1, triangle.v2,
                                            parabolicDistance, allowBackface);
}
...
inline bool rayPlaneIntersection(const glm::vec3& planePosition, const glm::vec3& planeNormal, const glm::vec3& rayStart,
                                 const glm::vec3& rayDirection, float& distanceOut) {
...
private:
    static void sutherlandHodgmanPolygonClip(glm::vec2* inVertexArray, glm::vec2* outVertexArray, int inLength, int& outLength,
                                             const LineSegment2& clipBoundary);

    static bool pointInsideBoundary(const glm::vec2& testVertex, const LineSegment2& clipBoundary);

    static void segmentIntersectsBoundary(const glm::vec2& first, const glm::vec2& second, const LineSegment2& clipBoundary,

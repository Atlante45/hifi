...
const int32_t BULLET_COLLISION_MASK_STATIC = ~(BULLET_COLLISION_GROUP_COLLISIONLESS | BULLET_COLLISION_GROUP_KINEMATIC |
                                               BULLET_COLLISION_GROUP_STATIC);
...
const uint16_t ENTITY_COLLISION_MASK_DEFAULT = USER_COLLISION_GROUP_STATIC | USER_COLLISION_GROUP_DYNAMIC |
                                               USER_COLLISION_GROUP_KINEMATIC | USER_COLLISION_GROUP_MY_AVATAR |
...
const uint16_t USER_COLLISION_MASK_ENTITIES = USER_COLLISION_GROUP_STATIC | USER_COLLISION_GROUP_DYNAMIC |

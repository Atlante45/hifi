...
const Solid<3>& tetrahedron() {
    ...
    static const Solid<3> TETRAHEDRON = Solid<3> { { A, B, C, D },
                                                   { vec2(0.75f, 0.5f), vec2(0.5f, 0.0f), vec2(0.25f, 0.5f), vec2(0.5f, 1.0f),
                                                     vec2(1.0f, 1.0f), vec2(0.75f, 0.5f), vec2(0.25f, 0.5f), vec2(0.5f, 1.0f),
                                                     vec2(0.75f, 0.5f), vec2(0.25f, 0.5f), vec2(0.0f, 1.0f), vec2(0.5f, 1.0f) },
                                                   FaceVector<3> {
                                                       Face<3> { { 0, 1, 2 } },
                                                       Face<3> { { 3, 1, 0 } },
                                                       Face<3> { { 2, 3, 0 } },
...
const Solid<4>& cube() {
    ...
    static const Solid<4> CUBE = Solid<4> { { A, B, C, D, -A, -B, -C, -D },
                                            { vec2(0.5f, 0.0f),          vec2(0.25f, 0.0f),         vec2(0.25f, THIRD),
                                              vec2(0.5f, THIRD),         vec2(0.5f, THIRD),         vec2(0.25f, THIRD),
                                              vec2(0.25f, 2.0f * THIRD), vec2(0.5f, 2.0f * THIRD),  vec2(0.25f, THIRD),
                                              vec2(0.0f, THIRD),         vec2(0.0f, 2.0f * THIRD),  vec2(0.25f, 2.0f * THIRD),
                                              vec2(1.0f, THIRD),         vec2(0.75f, THIRD),        vec2(0.75f, 2.0f * THIRD),
                                              vec2(1.0f, 2.0f * THIRD),  vec2(0.75f, THIRD),        vec2(0.5f, THIRD),
                                              vec2(0.5f, 2.0f * THIRD),  vec2(0.75f, 2.0f * THIRD), vec2(0.25f, 1.0f),
                                              vec2(0.5f, 1.0f),          vec2(0.5f, 2.0f * THIRD),  vec2(0.25f, 2.0f * THIRD) },
                                            FaceVector<4> {
                                                Face<4> { { 3, 2, 1, 0 } },
                                                Face<4> { { 0, 1, 7, 6 } },
                                                Face<4> { { 1, 2, 4, 7 } },
...
const Solid<3>& octahedron() {
    ...
    static const Solid<3> OCTAHEDRON = Solid<3> { { A, B, C, D, E, F },
                                                  { vec2(2.0f * SEVENTH, THIRD),
                                                    vec2(SEVENTH, 2.0f * THIRD),
                                                    vec2(3.0f * SEVENTH, 2.0f * THIRD),
                                                    vec2(2.0f * SEVENTH, THIRD),
                                                    vec2(3.0f * SEVENTH, 2.0f * THIRD),
                                                    vec2(4.0f * SEVENTH, THIRD),
                                                    vec2(5.0f * SEVENTH, 0.0f),
                                                    vec2(4.0f * SEVENTH, THIRD),
                                                    vec2(6.0f * SEVENTH, THIRD),
                                                    vec2(2.0f * SEVENTH, THIRD),
                                                    vec2(0.0f, THIRD),
                                                    vec2(1.0f * SEVENTH, 2.0f * THIRD),
                                                    vec2(2.0f * SEVENTH, 1.0f),
                                                    vec2(3.0f * SEVENTH, 2.0f * THIRD),
                                                    vec2(1.0f * SEVENTH, 2.0f * THIRD),
                                                    vec2(5.0f * SEVENTH, 2.0f * THIRD),
                                                    vec2(4.0f * SEVENTH, THIRD),
                                                    vec2(3.0f * SEVENTH, 2.0f * THIRD),
                                                    vec2(5.0f * SEVENTH, 2.0f * THIRD),
                                                    vec2(6.0f * SEVENTH, THIRD),
...
const Solid<5>& dodecahedron() {
    ...
    */
    ...
    // y1 and y2 are the solutions to the following system of equations (x is the sidelength, but is different than x1 because
    // the scale in the y direction is different): 1 = 3 * y1 + 2 * y2 y1 = sin(108 deg) * x y1 + y2 = x * sqrtf(5 + 2 *
    // sqrtf(5)) / 2
    static const float y1 = sqrtf(2.0f * (5.0f + sqrtf(5.0f))) /
                            (sqrtf(2.0f * (5.0f + sqrtf(5.0f))) + 4.0f * sqrtf(5.0f + 2.0f * sqrtf(5.0f)));
    static const float y2 = -(sqrtf(2.0f * (5.0f + sqrtf(5.0f))) - 2.0f * sqrtf(5.0f + 2.0f * sqrtf(5.0f))) /
                            (sqrtf(2.0f * (5.0f + sqrtf(5.0f))) + 4.0f * sqrtf(5.0f + 2.0f * sqrtf(5.0f)));
    ...
    static const Solid<5> DODECAHEDRON = Solid<5> { {
                                                    ...
                                                    { vec2(x1 + x2_2, 0.0f),
                                                      ...
                                                      vec2(x3 + x1, y1 + y2),
                                                      vec2(x3 + x1 + x2_2, y1),
                                                      vec2(1.0f - (x2 - x3 + x2_2), 0.0f),
                                                      vec2(1.0f - (x2 + x1 + x3), y2),
                                                      vec2(1.0f - (x2 + x1), y1 + y2),
                                                      vec2(1.0f - x2, y1 + y2),
                                                      vec2(1.0f - (x2 - x3), y2),
                                                      vec2(1.0f - x2_2, y1),
                                                      vec2(1.0f - x2, y1 + y2),
                                                      vec2(1.0f - (x3 + x1), y1 + y2 + y1),
                                                      vec2(1.0f - x3, y1 + y2 + y1),
                                                      vec2(1.0f, y1 + y2),
                                                      vec2(x3, y1 + y2),
                                                      vec2(0.0f, y1 + y2 + y1),
                                                      vec2(x2_2, y1 + y2 + y1 + y2),
                                                      vec2(x2, y1 + y2 + y1),
                                                      vec2(x1 + x3, y1 + y2),
                                                      vec2(x3 + x1, y1 + y2),
                                                      vec2(x2, y1 + y2 + y1),
                                                      ...
                                                      vec2(x3 + x1 + x2_2, y1),
                                                      vec2(x3 + x1 + x2, y1 + y2),
                                                      vec2(x3 + x1 + x2 + x2_2, y1),
                                                      vec2(x1 + x2 + x2_2, 0.0f),
                                                      vec2(x3 + x1 + x2_2 + x3, 0.0f),
                                                      vec2(1.0f - (x3 + x1 + x2_2), 1.0f - y1),
                                                      vec2(1.0f - (x3 + x1 + x2), 1.0f - (y1 + y2)),
                                                      vec2(1.0f - (x3 + x1 + x2 + x2_2), 1.0f - y1),
                                                      vec2(1.0f - (x1 + x2 + x2_2), 1.0f),
                                                      vec2(1.0f - (x3 + x1 + x2_2 + x3), 1.0f),
                                                      vec2(x2 + x1 + x3, 1.0f - y2),
                                                      vec2(x2 + x1, 1.0f - (y1 + y2)),
                                                      vec2(x2, 1.0f - (y1 + y2)),
                                                      vec2(x2 - x3, 1.0f - y2),
                                                      vec2(x2 - x3 + x2_2, 1.0f),
                                                      vec2(x2 + x1 + x2, y1 + y2 + y1),
                                                      vec2(x3 + x1 + x2 + x1, y1 + y2),
                                                      vec2(x3 + x1 + x2, y1 + y2),
                                                      vec2(x2 + x1, y1 + y2 + y1),
                                                      vec2(x2 + x1 + x2_2, y1 + y2 + y1 + y2),
                                                      vec2(1.0f - (x3 + x1 + x2), y1 + y2 + y1),
                                                      vec2(1.0f - (x2 + x1), y1 + y2),
                                                      vec2(1.0f - (x2 + x1 + x2_2), y1),
                                                      vec2(1.0f - (x2 + x1 + x2), y1 + y2),
                                                      vec2(1.0f - (x3 + x1 + x2 + x1), y1 + y2 + y1),
                                                      vec2(1.0f - (x3 + x1 + x2_2), y1 + y2 + y1 + y2),
                                                      vec2(1.0f - (x3 + x1), y1 + y2 + y1),
                                                      vec2(1.0f - x2, y1 + y2),
                                                      vec2(1.0f - (x2 + x1), y2 + y1),
                                                      vec2(1.0f - (x3 + x1 + x2), y1 + y2 + y1),
                                                      vec2(1.0f - (x1 + x2_2), 1.0f),
                                                      vec2(1.0f - x2_2, 1.0f),
                                                      vec2(1.0f - (x2_2 - x3), 1.0f - y1),
                                                      vec2(1.0f - (x1 + x3), 1.0f - (y1 + y2)),
                                                      vec2(1.0f - (x3 + x1 + x2_2), 1.0f - y1) },
                                                    FaceVector<5> {
                                                        Face<5> { { 0, 1, 2, 3, 4 } },
                                                        Face<5> { { 0, 5, 18, 6, 1 } },
...
const Solid<3>& icosahedron() {
    ...
    static const Solid<3> ICOSAHEDRON = Solid<3> { {
                                                   ...
                                                   { vec2(3.0f * ELEVENTH, 0.0f),
                                                     vec2(2.0f * ELEVENTH, THIRD),
                                                     vec2(4.0f * ELEVENTH, THIRD),
                                                     vec2(2.0f * ELEVENTH, THIRD),
                                                     vec2(3.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(4.0f * ELEVENTH, THIRD),
                                                     vec2(3.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(5.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(4.0f * ELEVENTH, THIRD),
                                                     vec2(5.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(6.0f * ELEVENTH, THIRD),
                                                     vec2(4.0f * ELEVENTH, THIRD),
                                                     vec2(6.0f * ELEVENTH, THIRD),
                                                     vec2(5.0f * ELEVENTH, 0.0f),
                                                     vec2(4.0f * ELEVENTH, THIRD),
                                                     vec2(1.0f * ELEVENTH, 0.0f),
                                                     vec2(0.0f, THIRD),
                                                     vec2(2.0f * ELEVENTH, THIRD),
                                                     vec2(1.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(2.0f * ELEVENTH, THIRD),
                                                     vec2(0.0f, THIRD),
                                                     vec2(2.0f * ELEVENTH, THIRD),
                                                     vec2(1.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(3.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(2.0f * ELEVENTH, 1.0f),
                                                     vec2(3.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(1.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(3.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(4.0f * ELEVENTH, 1.0f),
                                                     vec2(5.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(7.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(5.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(6.0f * ELEVENTH, 1.0f),
                                                     vec2(5.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(7.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(6.0f * ELEVENTH, THIRD),
                                                     vec2(8.0f * ELEVENTH, THIRD),
                                                     vec2(6.0f * ELEVENTH, THIRD),
                                                     vec2(7.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(6.0f * ELEVENTH, THIRD),
                                                     vec2(8.0f * ELEVENTH, THIRD),
                                                     vec2(7.0f * ELEVENTH, 0.0f),
                                                     vec2(10.0f * ELEVENTH, THIRD),
                                                     vec2(9.0f * ELEVENTH, 0.0f),
                                                     vec2(8.0f * ELEVENTH, THIRD),
                                                     vec2(7.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(8.0f * ELEVENTH, 1.0f),
                                                     vec2(9.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(8.0f * ELEVENTH, THIRD),
                                                     vec2(7.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(9.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(10.0f * ELEVENTH, THIRD),
                                                     ...
                                                     vec2(10.0f * ELEVENTH, THIRD),
                                                     vec2(9.0f * ELEVENTH, 2.0f * THIRD),
                                                     vec2(10.0f * ELEVENTH, 1.0f),
                                                     vec2(1.0f, 2.0f * THIRD),
                                                     vec2(9.0f * ELEVENTH, 2.0f * THIRD) },
                                                   FaceVector<3> {
                                                       Face<3> { { 1, 2, 0 } },  Face<3> { { 2, 3, 0 } },
                                                       Face<3> { { 3, 4, 0 } },  Face<3> { { 4, 5, 0 } },
                                                       Face<3> { { 5, 1, 0 } },

                                                       Face<3> { { 1, 10, 2 } }, Face<3> { { 11, 2, 10 } },
                                                       Face<3> { { 2, 11, 3 } }, Face<3> { { 7, 3, 11 } },
                                                       Face<3> { { 3, 7, 4 } },  Face<3> { { 8, 4, 7 } },
                                                       Face<3> { { 4, 8, 5 } },  Face<3> { { 9, 5, 8 } },
                                                       Face<3> { { 5, 9, 1 } },  Face<3> { { 10, 1, 9 } },

                                                       Face<3> { { 8, 7, 6 } },  Face<3> { { 9, 8, 6 } },
                                                       Face<3> { { 10, 9, 6 } }, Face<3> { { 11, 10, 6 } },
                                                       Face<3> { { 7, 11, 6 } },
                                                   } }
                                            .fitDimension(0.5f);
    return ICOSAHEDRON;

...
public:
    ...
    ScriptableMeshPart& operator=(const ScriptableMeshPart& view) {
        parentMesh = view.parentMesh;
        return *this;
    };
    ScriptableMeshPart(const ScriptableMeshPart& other) :
...
public slots:
    ...
    bool replaceMeshPartData(scriptable::ScriptableMeshPartPointer source,

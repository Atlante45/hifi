...
public:
    ...
    public:
        ...
        Builder& withDepthOnly() {
            _flags.set(DEPTH_ONLY);
            return (*this);
        }
    ...
    public:
        ...
        public:
            ...
            Builder& withDepthOnly() {
                _flags.set(DEPTH_ONLY);
                _mask.set(DEPTH_ONLY);
                return (*this);
            }
            Builder& withoutDepthOnly() {
                _flags.reset(DEPTH_ONLY);
                _mask.set(DEPTH_ONLY);
                return (*this);
            }
    ...
    if (key.isValid()) {
        if (key.hasOwnPipeline()) {
            ...
            debug << "[ShapeKey:"
                  ...
                  << "isDualQuatSkinned:" << key.isDualQuatSkinned() << "isDepthOnly:" << key.isDepthOnly()
                  << "isDepthBiased:" << key.isDepthBiased() << "isWireframe:" << key.isWireframe()

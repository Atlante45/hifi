...
void renderShapes(const RenderContextPointer& renderContext, const ShapePlumberPointer& shapeContext, const ItemBounds& inItems,
                  int maxDrawnItems = -1, const ShapeKey& globalKey = ShapeKey());
void renderStateSortShapes(const RenderContextPointer& renderContext, const ShapePlumberPointer& shapeContext,
                           const ItemBounds& inItems, int maxDrawnItems = -1, const ShapeKey& globalKey = ShapeKey());
...
public:
    ...
    void run(const render::RenderContextPointer& renderContext, const Inputs& items);
...
protected:
    ...
    void run(const render::RenderContextPointer& renderContext, const glm::vec3 vertices[8], const gpu::BufferView& indices,
             int indexCount);

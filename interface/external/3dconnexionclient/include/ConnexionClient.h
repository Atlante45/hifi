...
#define kConnexionCtlCalibrate                                                                                                 \
    '3dca' // calibrate the device with the current axes values (same as executing the calibrate assignment)
...
#define kConnexionCtlSetSwitches                                                                                               \
    '3dss' // set the current state of the client-controlled feature switches (bitmap, see masks below)

// Client capability mask constants (this mask defines which buttons and controls should be sent to clients, the others are
...
#define kConnexionDeviceStateVers                                                                                              \
    0x6D33 // 'm3' (version 3 includes 32-bit button data in previously unused field, binary compatible with version 2)

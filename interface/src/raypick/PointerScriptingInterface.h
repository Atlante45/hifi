 ...
 * on {@link Entities} and {@link Overlays}.
 *
 * @namespace Pointers
 *
 * @hifi-interface
...
public:
     ...
     * or overlay focus to the object at which the Pointer is aimed.  Buttons besides the first three will still trigger events,
     * but event.button will be "None".
     */
    /**jsdoc
     * Adds a new Pointer
     ...
     * create a Static Ray Pointer, a Mouse Ray Pointer, or a Joint Ray Pointer.
    ...
    /**jsdoc
     * Sets a list of Entity IDs, Overlay IDs, and/or Avatar IDs to include during intersection, instead of intersecting with
     * everything.  Stylus Pointers <b>only</b> intersect with objects in their include list.
    ...
    /**jsdoc
     * Lock a Pointer onto a specific object (overlay, entity, or avatar).  Optionally, provide an offset in object-space,
     * otherwise the Pointer will lock on to the center of the object. Not used by Stylus Pointers.
     ...
     * information about the Pointer. Currently only includes renderStates and defaultRenderStates with associated overlay IDs.
     */

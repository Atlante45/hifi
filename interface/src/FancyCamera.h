...
public slots:
    /**jsdoc
     * Get the ID of the entity that the camera is set to use the position and orientation from when it's in entity mode. You
     * can also get the entity ID using the <code>Camera.cameraEntity</code> property.
    ...
    /**jsdoc
     * Set the entity that the camera should use the position and orientation from when it's in entity mode. You can also set
     * the entity using the <code>Camera.cameraEntity</code> property.

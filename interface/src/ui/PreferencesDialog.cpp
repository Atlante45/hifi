...
void setupPreferences() {
    ...
    static const QString VIEW_CATEGORY { "View" };
    {
        ...
        auto preference = new SpinnerPreference(VIEW_CATEGORY, "Real world vertical field of view (angular size of monitor)",
                                                getter, setter);
        preference->setMin(1);
    ...
    */
    ...
    static const QString VR_MOVEMENT { "VR Movement" };
    {
        ...
        auto preference = new RadioButtonsPreference(VR_MOVEMENT, "Teleporting only / Walking and teleporting", getter, setter);
        QStringList items;
        items << "Teleporting only"

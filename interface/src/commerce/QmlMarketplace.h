...
protected:
    ...
    Q_INVOKABLE void getMarketplaceItems(const QString& q = QString(), const QString& view = QString(),
                                         const QString& category = QString(), const QString& adminFilter = QString("published"),
                                         const QString& adminFilterCost = QString(), const QString& sort = QString(),
                                         bool isAscending = false, bool isFree = false, int page = 1, int perPage = 20);
...
private:
    void send(const QString& endpoint, const QString& success, const QString& fail, QNetworkAccessManager::Operation method,
              AccountManagerAuth::Type authType, const QUrlQuery& request = QUrlQuery());
